...
const _ESPECIES = JSON.parse(_rfs(new URL("../data/especies.json", import.meta.url)));
const _INCOMPATS = JSON.parse(_rfs(new URL("../data/incompatibilidades.json", import.meta.url)));
